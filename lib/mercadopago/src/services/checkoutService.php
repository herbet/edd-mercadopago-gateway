...
class CheckoutService {
	public function create_checkout_preference ($checkoutPreferenceData,$accessToken) {//checkoutPreferenceData must be a CheckoutPreferenceData Object, accessToken must be string
		...
		$checkoutPreferenceItems->setItemsId(isset($preferenceContent['items'][0]['id'])?$preferenceContent['items'][0]['id']:"");
		$checkoutPreferenceItems->setTitle(isset($preferenceContent['items'][0]['title'])?$preferenceContent['items'][0]['title']:"");
		$checkoutPreferenceItems->setDescription(isset($preferenceContent['description'][0]['id'])?$preferenceContent['description'][0]['id']:"");
		$checkoutPreferenceItems->setQuantity(isset($preferenceContent['items'][0]['quantity'])?(int)$preferenceContent['items'][0]['quantity']:"");
		$checkoutPreferenceItems->setUnitPrice(isset($preferenceContent['items'][0]['unit_price'])?$preferenceContent['items'][0]['unit_price']:"");
		$checkoutPreferenceItems->setCurrencyId(isset($preferenceContent['items'][0]['currency_id'])?$preferenceContent['items'][0]['currency_id']:"");
		$checkoutPreferenceItems->setPictureUrl(isset($preferenceContent['items'][0]['picture_url'])?$preferenceContent['items'][0]['picture_url']:"");
	
		$checkoutPreferencePayer = new CheckoutPreferencePayer(); 
		$checkoutPreferencePayer->setName(isset($preferenceContent['payer']['name'])?$preferenceContent['payer']['name']:"");
		$checkoutPreferencePayer->setSurname(isset($preferenceContent['payer']['surname'])?$preferenceContent['payer']['surname']:"");
		$checkoutPreferencePayer->setEmail(isset($preferenceContent['payer']['email'])?$preferenceContent['payer']['email']:"");

		$checkoutPreferenceBackUrls = new CheckoutPreferenceBackUrls(); 
		$checkoutPreferenceBackUrls->setSuccessUrl(isset($preferenceContent['back_urls']['success'])?$preferenceContent['back_urls']['success']:"");
		$checkoutPreferenceBackUrls->seTpendingUrl(isset($preferenceContent['back_urls']['pending'])?$preferenceContent['back_urls']['pending']:"");
		$checkoutPreferenceBackUrls->setFailureUrl(isset($preferenceContent['back_urls']['failure'])?$preferenceContent['back_urls']['failure']:"");

		
		$checkoutPreferencePaymentMethods = new CheckoutPreferencePaymentMethods(); 
		$checkoutPreferencePaymentMethods->setInstallments(isset($preferenceContent['payment_methods']['installments'])?$preferenceContent['payment_methods']['installments']:"");
		...
		$checkoutPreferenceExcludedPaymentMethods->setExcludedPaymentMethodsId(isset($preferenceContent['payment_methods']['excluded_payment_methods'][$q]['id'])?$preferenceContent['payment_methods']['excluded_payment_methods'][$q]['id']:"");
		...
		$checkoutPreferenceExcludedPaymentTypes->setExcludedPaymentTypesId(isset($preferenceContent['payment_methods']['excluded_payment_types'][$w]['id'])?$preferenceContent['payment_methods']['excluded_payment_types'][$w]['id']:"");
		...
		$checkoutPreference->setExternalReference(isset($preferenceContent['external_reference'])?$preferenceContent['external_reference']:"");
		$checkoutPreference->setExpires(isset($preferenceContent['expires'])?$preferenceContent['expires']:false); 
		$checkoutPreference->setCollectorId(isset($preferenceContent['collector_id'])?$preferenceContent['collector_id']:"");
		$checkoutPreference->setSubscriptionPlanId(isset($preferenceContent['subscription_plan_id'])?$preferenceContent['subscription_plan_id']:"");
		$checkoutPreference->setExpirationDateFrom(isset($preferenceContent['expiration_date_from'])?$preferenceContent['expiration_date_from']:"");
		$checkoutPreference->setExpirationDateTo(isset($preferenceContent['expiration_date_to'])?$preferenceContent['expiration_date_to']:"");
		$checkoutPreference->setInitPoint(isset($preferenceContent['init_point'])?$preferenceContent['init_point']:"");
		$checkoutPreference->setDateCreated(isset($preferenceContent['date_created'])?$preferenceContent['date_created']:"");
